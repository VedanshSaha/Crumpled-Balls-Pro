  ...
  function (t, e, n) {
    ...
    void 0 ===
      (i = function () {
        ...
        var e;
        return (
          (c.prototype.set = function (t, e, n) {
            ...
            t: for (var o in t) {
              ...
              var p = r[o];
              this.isUndef(p) ||
                ((c.Signal && p instanceof c.Signal) ||
                (c.Param && p instanceof c.Param)
                  ? p.value !== e &&
                    (this.isUndef(n) ? (p.value = e) : p.rampTo(e, n))
          ...
          (c.prototype.get = function (t) {
            ...
            for (var e = {}, n = 0; n < t.length; n++) {
              ...
              this.isObject(t[i])
                ...
                : p instanceof c
                ? (r[i] = p.get())
                : this.isFunction(p) || this.isUndef(p) || (r[i] = p);
            }
            return e;
          }),
          ...
          (AudioNode.prototype.chain = c.prototype.chain),
          (AudioNode.prototype.fan = c.prototype.fan),
          (c.prototype.defaultArg = function (t, e) {
          ...
          (c.noOp = function () {}),
          (c.prototype._readOnly = function (t) {
            if (Array.isArray(t))
          ...
          Object.defineProperty(c, "context", {
            ...
            set: function (t) {
              (e = c.Context && t instanceof c.Context ? t : new c.Context(t)),
                c.Context && c.Context.emit("init", e);
            },
          }),
          ...
          return (
            ...
            (p5.prototype.masterVolume = function (t, e, n) {
              if ("number" == typeof t) {
                ...
                r.output.gain.cancelScheduledValues(i + n),
                  r.output.gain.linearRampToValueAtTime(o, i + n),
                  r.output.gain.linearRampToValueAtTime(t, i + n + e);
              } else {
                if (!t) return r.output.gain;
                t.connect(r.output.gain);
              }
            }),
            (p5.prototype.soundOut = p5.soundOut = r),
            (p5.soundOut._silentNode = r.audiocontext.createGain()),
            (p5.soundOut._silentNode.gain.value = 0),
            p5.soundOut._silentNode.connect(r.audiocontext.destination),
            r
          );
  ...
  function (t, e, n) {
    ...
    void 0 ===
      (i = function (t) {
        ...
        return (
          (p5.Effect = function () {
            (this.ac = r.audiocontext),
              (this.input = this.ac.createGain()),
              (this.output = this.ac.createGain()),
              (this._drywet = new e(1)),
          ...
          (p5.Effect.prototype.amp = function (t, e, n) {
            ...
            this.output.gain.cancelScheduledValues(i),
              this.output.gain.linearRampToValueAtTime(o, i + n + 0.001),
              this.output.gain.linearRampToValueAtTime(t, i + n + e + 0.001);
          }),
      ...
      (n = function (t) {
        ...
        return (
          ...
          (p5.prototype.disposeSound = function () {
            for (var t = 0; t < u.soundArray.length; t++)
              u.soundArray[t].dispose();
          }),
            ...
            if ("string" == typeof t) {
              ...
              if (-1 < ["mp3", "wav", "ogg", "m4a", "aac"].indexOf(n))
                if (p5.prototype.isFileSupported(n)) e = e;
                  ...
                  for (
                    var i = e.split("."), o = i[i.length - 1], r = 0;
                    r < u.extensions.length;
                    r++
                  ) {
          ...
          (p5.prototype._mathChain = function (t, e, n, i, o) {
            for (var r in t.mathOps)
              t.mathOps[r] instanceof o &&
                (t.mathOps[r].dispose(),
                (n = r) < t.mathOps.length - 1 && (i = t.mathOps[r + 1]));
            return (
          ...
          }),
          {
            convertToWav: function (t) {
              ...
              p(o, 0, "RIFF"),
                o.setUint32(4, 36 + 2 * n.length, !0),
                p(o, 8, "WAVE"),
                p(o, 12, "fmt "),
                o.setUint32(16, 16, !0),
                o.setUint16(20, 1, !0),
                o.setUint16(22, 2, !0),
                o.setUint32(24, u.audiocontext.sampleRate, !0),
                o.setUint32(28, 4 * u.audiocontext.sampleRate, !0),
                o.setUint16(32, 4, !0),
                o.setUint16(34, 16, !0),
                p(o, 36, "data"),
                o.setUint32(40, 2 * n.length, !0);
              for (var r = n.length, s = 44, a = 0; a < r; a++)
                o.setInt16(s, 32767 * n[a], !0), (s += 2);
              return o;
            },
            midiToFreq: n,
      ...
      void 0 ===
        (o = function (u) {
          ...
          return (
            ...
            (u.TimelineSignal.prototype.exponentialRampToValueAtTime = function (
              t,
              e
            ) {
              e = this.toSeconds(e);
            ...
            (u.TimelineSignal.prototype.setValueCurveAtTime = function (
              ...
              for (var o = new Array(t.length), r = 0; r < o.length; r++)
                o[r] = this._fromUnits(t[r]) * i;
              (e = this.toSeconds(e)),
                (n = this.toSeconds(n)),
                this._events.add({
            ...
            (u.TimelineSignal.prototype.exponentialRampToValueBetween = function (
              t,
              e,
              n
            ) {
            ...
            (u.TimelineSignal.prototype.getValueAtTime = function (t) {
              ...
              if (null === n) i = this._initial;
                ...
                (o = null === r ? this._initial : r.value),
            ...
            (u.TimelineSignal.prototype._curveInterpolate = function (
              ...
              return a === s
                ? u
                : this._linearInterpolate(s, u, a, p, r * (o - 1));
            }),
    ...
    void 0 ===
      (i = function (t) {
        ...
        return (
          ...
          (p5.Filter.prototype = Object.create(e.prototype)),
          (p5.Filter.prototype.process = function (t, e, n, i) {
            ...
            (s.Emitter.prototype.emit = function (t) {
              if (this._events) {
                ...
                if (this._events.hasOwnProperty(t))
                  for (var n = this._events[t], i = 0, o = n.length; i < o; i++)
                    n[i].apply(this, e);
              }
              return this;
            }),
        ...
        (o = function (n) {
          return (
            ...
            (n.Time.prototype._toNotationHelper = function (t, e) {
              for (
                var n = this._notationToUnits(e[e.length - 1]), i = "", o = 0;
                o < e.length;
                o++
              ) {
      ...
      (i = function (t) {
        ...
        (p5.Oscillator = function (t, e) {
          ...
          (this.started = !1),
            ...
            (this.oscillator = s.audiocontext.createOscillator()),
            (this.f = t || 440),
            (this.oscillator.type = e || "sine"),
            this.oscillator.frequency.setValueAtTime(
              this.f,
              s.audiocontext.currentTime
            ),
            (this.output = s.audiocontext.createGain()),
            (this._freqMods = []),
            (this.output.gain.value = 0.5),
            this.output.gain.setValueAtTime(0.5, s.audiocontext.currentTime),
            this.oscillator.connect(this.output),
            (this.panPosition = 0),
            (this.connection = s.input),
          ...
          (p5.Oscillator.prototype.start = function (t, e) {
            ...
            if (!this.started) {
              ...
              this.oscillator.connect(this.output),
              (t = t || 0),
              this.oscillator.start(t + s.audiocontext.currentTime),
              (this.freqNode = this.oscillator.frequency),
              this._freqMods))
                void 0 !== this._freqMods[r].connect &&
                  this._freqMods[r].connect(this.oscillator.frequency);
              this.started = !0;
            }
          }),
          ...
          (p5.Oscillator.prototype.freq = function (t, e, n) {
            if ("number" != typeof t || isNaN(t)) {
              ...
              (n = n || 0), (e = e || 0);
              0 === e
                ? this.oscillator.frequency.setValueAtTime(t, n + i)
                : 0 < t
          ...
          (p5.Oscillator.prototype.phase = function (t) {
            ...
            (this.phaseAmount = t),
              this.dNode ||
                ((this.dNode = s.audiocontext.createDelay()),
        ...
        (p5.Oscillator.prototype.add = function (t) {
          ...
          (p5.Oscillator.prototype.scale = function (t, e, n, i) {
            ...
            r =
              4 === arguments.length
                ? ((o = p5.prototype.map(n, t, e, 0, 1) - 0.5),
              ...
              for (
                ...
                if (e !== this._lastState) {
                  ...
                  e === o.State.Started
                    ...
                    : e === o.State.Paused && this.emit("pause", n.time);
                }
                var i = this._nextTick;
                this.frequency &&
                  ((this._nextTick +=
                    1 / this.frequency.getValueAtTime(this._nextTick)),
                  e === o.State.Started && (this.callback(i), this.ticks++));
              }
            }),
      ...
      (n = function (t) {
        ...
        (p5.MonoSynth = function () {
          e.call(this),
            ...
            this.connect(),
            n.soundArray.push(this);
        }),
          (p5.MonoSynth.prototype = Object.create(p5.AudioVoice.prototype)),
          (p5.MonoSynth.prototype.play = function (t, e, n, i) {
          ...
          (p5.MonoSynth.prototype.triggerAttack = function (t, e, n) {
            ...
            var i = r(t),
              o = e || 0.1;
            this.oscillator.freq(i, 0, n),
              this.env.ramp(this.output.gain, n, o);
          }),
      ...
      (n = function () {
        ...
        return (
          (p5.AudioVoice = function () {
            (this.ac = n.audiocontext),
              (this.output = this.ac.createGain()),
              this.connect(),
              n.soundArray.push(this);
          }),
          (p5.AudioVoice.prototype.play = function (t, e, n, i) {}),
          (p5.AudioVoice.prototype.triggerAttack = function (t, e, n) {}),
          (p5.AudioVoice.prototype.triggerRelease = function (t) {}),
          (p5.AudioVoice.prototype.amp = function (t, e) {}),
          (p5.AudioVoice.prototype.connect = function (t) {
            var e = t || n.input;
            this.output.connect(e.input ? e.input : e);
          }),
      ...
      (i = function (t) {
        ...
        (p5.PolySynth = function (t, e) {
          (this.audiovoices = []),
            ...
            (this._voicesInUse = new h(0)),
            (this.output = c.audiocontext.createGain()),
            this.connect(),
            this._allocateVoices(),
            c.soundArray.push(this);
        }),
          ...
          (p5.PolySynth.prototype.noteADSR = function (t, e, n, i, o, r) {
            ...
            this.audiovoices[this.notes[t].getValueAtTime(s)].setADSR(
              e,
              n,
              i,
              o
          ...
          (p5.PolySynth.prototype.noteAttack = function (t, e, n) {
            n = ~~n;
            var i,
              o = c.audiocontext.currentTime + n,
              r = l(t),
              s = e || 0.1;
            if (
              (this.notes[r] &&
                null !== this.notes[r].getValueAtTime(o) &&
                this.noteRelease(r, 0),
              this._voicesInUse.getValueAtTime(o) < this.maxVoices)
            )
              i = Math.max(~~this._voicesInUse.getValueAtTime(o), 0);
            else {
              i = this._oldest;
              var a = p5.prototype.freqToMidi(
          ...
          (p5.PolySynth.prototype.noteRelease = function (t, e) {
            ...
            if (t) {
              ...
              if (this.notes[r] && null !== this.notes[r].getValueAtTime(o)) {
                var s = Math.max(
                  ~~this._voicesInUse.getValueAtTime(o).value,
                  1
                );
                this._voicesInUse.setValueAtTime(s - 1, o),
                  0 < s && this._updateAfter(o, -1),
                  this.audiovoices[
                    this.notes[r].getValueAtTime(o)
                  ].triggerRelease(i),
                  this.notes[r].dispose(),
                  delete this.notes[r],
                  (this._newest =
                    0 === this._newest
                      ? 0
              ...
              this._voicesInUse.setValueAtTime(0, o),
              this.notes))
      ...
      (i = function () {
        ...
        p5.prototype.isFileSupported = function (t) {
          switch (t.toLowerCase()) {
            ...
            case "ogg":
              return (
                !!e.canPlayType && e.canPlayType('audio/ogg; codecs="vorbis"')
              );
            case "aac":
            case "m4a":
            case "mp4":
  ...
  function (t, e, n) {
    ...
    void 0 ===
      (i = function (_tt) {
        ...
        void 0 !== a.createStereoPanner
          ? ((p5.Panner = function (t, e) {
          ...
          : ((p5.Panner = function (t, e, n) {
              (this.input = a.createGain()),
                ...
                (this.left = a.createGain()),
                (this.right = a.createGain()),
                (this.left.channelInterpretation = "discrete"),
                (this.right.channelInterpretation = "discrete"),
                1 < n
                  ? ((this.splitter = a.createChannelSplitter(2)),
                    this.input.connect(this.splitter),
                    this.splitter.connect(this.left, 1),
                    this.splitter.connect(this.right, 0))
                  : (this.input.connect(this.left),
                    this.input.connect(this.right)),
                (this.output = a.createChannelMerger(2)),
            ...
            (p5.Panner.prototype.pan = function (t, e) {
              ...
              this.left.gain.linearRampToValueAtTime(s, i),
                this.right.gain.linearRampToValueAtTime(r, i);
            }),
      ...
      (n = function (t) {
        ...
        (p5.SoundFile = function (t, e, n, i) {
          ...
          (this._onended = function () {}),
            ...
            (this.buffer = null),
            (this.playbackRate = 1),
            (this.input = u.audiocontext.createGain()),
            (this.output = u.audiocontext.createGain()),
            (this.reversed = !1),
            (this.startTime = 0),
            (this.endTime = null),
            (this.pauseTime = 0),
            ...
            (this.panPosition = 0),
            (this.panner = new p5.Panner(this.output, u.input, 2)),
            (this.url || this.file) && this.load(e, n),
            u.soundArray.push(this),
          ...
          (p5.prototype.loadSound = function (t, e, n, i) {
            ...
            return new p5.SoundFile(
              t,
              function () {
                "function" == typeof e && e.apply(o, arguments),
          ...
          (p5.SoundFile.prototype.load = function (n, i) {
            ...
            if (void 0 !== this.url && "" !== this.url) {
                  ...
                  if (200 === s.status) {
                    ...
                    p.decodeAudioData(
                      ...
                      function (t) {
                        o.panner &&
                          ((o.buffer = t),
                          o.panner.inputChannels(t.numberOfChannels),
                          n && n(o));
                      },
                      function () {
                        if (o.panner) {
              ...
              (t.onload = function () {
                o.panner &&
                  p.decodeAudioData(t.result, function (t) {
                    o.panner &&
                      ((o.buffer = t),
                      o.panner.inputChannels(t.numberOfChannels),
                      n && n(o));
          ...
          (p5.SoundFile.prototype.play = function (t, e, n, i, o) {
            if (this.output) {
              ...
              if (
                ...
                (o =
                  o &&
                  (o <= this.buffer.duration - r ? o : this.buffer.duration)),
                  this._paused
                    ? (this.bufferSourceNode.start(a, this.pauseTime, o),
                      this._counterNode.start(a, this.pauseTime, o))
                    : (this.bufferSourceNode.start(a, r, o),
                      this._counterNode.start(a, r, o)),
                  (this._playing = !0),
                  (this._paused = !1),
          ...
          (p5.SoundFile.prototype.setVolume = function (t, e, n) {
            if ("number" == typeof t) {
              ...
              this.output.gain.cancelScheduledValues(r + o),
                ...
                this.output.gain.linearRampToValueAtTime(t, r + o + i);
            } else {
              if (!t) return this.output.gain;
              t.connect(this.output.gain);
            }
          ...
          (p5.SoundFile.prototype.currentTime = function () {
            return this.reversed
              ? Math.abs(this._lastPos - this.buffer.length) / p.sampleRate
              : this._lastPos / p.sampleRate;
          }),
        ...
        (p5.SoundFile.prototype._initCounterNode = function () {
          ...
          return (
            ...
            (n._workletNode = new AudioWorkletNode(p, s.soundFileProcessor, {
              processorOptions: { bufferSize: o },
            })),
            ...
            (i.buffer = (function (t) {
              for (
                var e = t.length,
                  n = p.createBuffer(1, t.length, p.sampleRate),
              ...
              (h.oncomplete = function (t) {
                if (self.panner) {
                      ...
                      t.forEach(function (e) {
                        try {
                          ...
                          if (
                            ...
                            if (isNaN(n)) return;
                            o.push({ tempo: Math.round(n), count: e.count });
                          }
                        } catch (t) {
                          throw t;
                        }
                  ...
                  var o = (function (t, e, n, i) {
                    for (
                      var o = [], r = Object.keys(t).sort(), s = 0;
                      s < r.length;
                      s++
                    )
                      for (
                        var a = r[s], u = t[a], p = 0;
                        p < u.intervals.length;
                        p++
                      ) {
                        var c = Math.round(Math.abs(60 / (u.intervals[p] / n)));
                        (c = m(c)),
                          Math.abs(c - e) < i && o.push(u.sampleIndex / n);
                      }
        ...
        (p5.SoundFile.prototype.addCue = function (t, e, n) {
          ...
          (p5.SoundFile.prototype._onTimeUpdate = function (t) {
            for (
              var e = t / this.buffer.sampleRate, n = this._cues.length, i = 0;
              i < n;
              i++
            ) {
              var o = this._cues[i],
    ...
    void 0 ===
      (n = function (t) {
        ...
        (p5.Amplitude = function (t) {
          (this.bufferSize = e(2048)),
            (this.audiocontext = n.audiocontext),
            (this._workletNode = new AudioWorkletNode(
              this.audiocontext,
              i.amplitudeProcessor,
              {
            ...
            this.output.connect(this.audiocontext.destination),
            n.meter.connect(this._workletNode),
            n.soundArray.push(this);
        }),
          (p5.Amplitude.prototype.setInput = function (t, e) {
            n.meter.disconnect(),
              ...
              null == t
                ? n.meter.connect(this._workletNode)
                : t instanceof p5.Signal
                ? t.output.connect(this._workletNode)
                : t
          ...
          (p5.Amplitude.prototype.connect = function (t) {
            t
              ? t.hasOwnProperty("input")
                ...
                : this.output.connect(t)
              : this.output.connect(this.panner.connect(n.input));
          }),
  ...
  function (t, e, o) {
    ...
    void 0 ===
      (n = function (t) {
        var c = o(1);
        (p5.FFT = function (t, e) {
          (this.input = this.analyser = c.audiocontext.createAnalyser()),
            ...
            this.smooth(t),
            (this.bins = e || 1024),
            c.fftMeter.connect(this.analyser),
          ...
          (p5.FFT.prototype.setInput = function (t) {
            t
              ? (t.output
                ...
                c.fftMeter.disconnect())
              : c.fftMeter.connect(this.analyser);
          }),
          (p5.FFT.prototype.waveform = function () {
            for (var t, e, n = 0; n < arguments.length; n++)
              "number" == typeof arguments[n] &&
                ((t = arguments[n]), (this.analyser.fftSize = 2 * t)),
                "string" == typeof arguments[n] && (e = arguments[n]);
          ...
          (p5.FFT.prototype.getEnergy = function (t, e) {
            ...
            if (e) {
              if (t && e) {
                ...
                for (
                  var o = Math.round((t / n) * this.freqDomain.length),
                    r = Math.round((e / n) * this.freqDomain.length),
                    s = 0,
                    a = 0,
                    u = o;
                  u <= r;
          ...
          (p5.FFT.prototype.getCentroid = function () {
            for (
              var t = c.audiocontext.sampleRate / 2, e = 0, n = 0, i = 0;
          ...
          (p5.FFT.prototype.logAverages = function (t) {
            for (
              var e = c.audiocontext.sampleRate / 2,
                n = this.freqDomain,
                i = n.length,
              ...
              Math.round((s * e) / this.freqDomain.length) > t[r].hi && r++,
                (o[r] = void 0 !== o[r] ? (o[r] + n[s]) / 2 : n[s]);
            }
            return o;
          }),
          (p5.FFT.prototype.getOctaveBands = function (t, e) {
            ...
            for (var o = c.audiocontext.sampleRate / 2; i.hi < o; ) {
              var r = {};
              (r.lo = i.hi),
                (r.ctr = i.ctr * Math.pow(2, 1 / t)),
                (r.hi = r.ctr * Math.pow(2, 1 / (2 * t))),
                n.push(r),
                (i = r);
            }
            return n;
    ...
    void 0 ===
      (n = function (t) {
        ...
        (p5.Signal = function (t) {
          ...
          (a.prototype.add = e.prototype.add),
          ...
          (a.prototype.mult = e.prototype.mult),
          (e.prototype.scale = function (t, e, n, i) {
            var o, r;
            r =
              4 === arguments.length
                ? ((o = p5.prototype.map(n, t, e, 0, 1) - 0.5),
          ...
          (a.prototype.scale = e.prototype.scale);
      }.call(e, o, e, t)) || (t.exports = n);
  },
  function (t, e, n) {
    var i, o;
        ...
        (o = function (o) {
          (o.Frequency = function (t, e) {
            ...
            (o.Frequency.prototype.harmonize = function (t) {
              return (
                (this._expr = function (t, e) {
                  for (var n = t(), i = [], o = 0; o < e.length; o++)
                    i[o] = n * this.intervalToFrequencyRatio(e[o]);
                  return i;
                }.bind(this, this._expr, t)),
                this
              );
          ...
          return (
            (o.Frequency.A4 = 440),
            (o.Frequency.prototype.midiToFrequency = function (t) {
      ...
      (i = function (t) {
        ...
        (p5.Envelope = function (t, e, n, i, o, r) {
          ...
          (p5.Envelope.prototype.ramp = function (t, e, n, i) {
            ...
            a < r
              ? (this.control.setTargetAtTime(r, o, this._rampAttackTC),
                (o += this._rampAttackTime))
              : r < a &&
                (this.control.setTargetAtTime(r, o, this._rampDecayTC),
                (o += this._rampDecayTime)),
              void 0 !== s &&
                (r < s
                  ? this.control.setTargetAtTime(s, o, this._rampAttackTC)
                  : s < r &&
                    this.control.setTargetAtTime(s, o, this._rampDecayTC));
          }),
          (p5.Envelope.prototype.connect = function (t) {
            ((this.connection = t) instanceof p5.Oscillator ||
              ...
              (t = t.output.gain),
              t instanceof AudioParam &&
                t.setValueAtTime(0, u.audiocontext.currentTime),
              t instanceof p5.Signal && t.setValue(0),
              this.output.connect(t);
          }),
  ...
  function (t, e, n) {
    ...
    void 0 ===
      (i = function (t) {
        ...
        n(23),
          (p5.Pulse = function (t, e) {
            p5.Oscillator.call(this, t, "sawtooth"),
              (this.w = e || 0),
              (this.osc2 = new p5.SawOsc(t)),
              (this.dNode = s.audiocontext.createDelay()),
              (this.dcOffset = a()),
              (this.dcGain = s.audiocontext.createGain()),
              this.dcOffset.connect(this.dcGain),
              this.dcGain.connect(this.output),
              (this.f = t || 440);
            var n = this.w / this.oscillator.frequency.value;
            (this.dNode.delayTime.value = n),
          ...
          (p5.Pulse.prototype.width = function (t) {
            if ("number" == typeof t) {
              ...
              var n = new p5.SignalAdd(-0.5);
              n.setInput(t),
                (n = (n = n.mult(-1)).mult(1.7)).connect(this.dcGain.gain);
            }
          }),
          (p5.Pulse.prototype.start = function (t, e) {
            ...
            if (!this.started) {
              ...
              (this.oscillator = s.audiocontext.createOscillator()),
                this.oscillator.frequency.setValueAtTime(o, n),
                (this.oscillator.type = r),
                this.oscillator.connect(this.output),
                this.oscillator.start(i + n),
                (this.osc2.oscillator = s.audiocontext.createOscillator()),
                this.osc2.oscillator.frequency.setValueAtTime(o, i + n),
                (this.osc2.oscillator.type = r),
          ...
          (p5.Pulse.prototype.freq = function (t, e, n) {
            if ("number" == typeof t) {
              ...
              var i = s.audiocontext.currentTime,
                o =
                  ((e = e || 0), (n = n || 0), this.oscillator.frequency.value);
      ...
      (n = function (t) {
        ...
        (p5.Noise = function (t) {
          ...
          p5.Oscillator.call(this),
            ...
            (e = "brown" === t ? o : "pink" === t ? i : n),
            (this.buffer = e);
        }),
          (p5.Noise.prototype = Object.create(p5.Oscillator.prototype));
        var n = (function () {
            for (
              var t = 2 * l.audiocontext.sampleRate,
                e = l.audiocontext.createBuffer(
                  1,
                  t,
                  l.audiocontext.sampleRate
                ),
                n = e.getChannelData(0),
                i = 0;
              i < t;
          ...
          i = (function () {
            ...
            for (var c = 0; c < a; c++) {
              ...
              (t = 0.99886 * t + 0.0555179 * h),
                ...
                (o = 0.55 * o + 0.5329522 * h),
                (r = -0.7616 * r - 0.016898 * h),
                (p[c] = t + e + n + i + o + r + s + 0.5362 * h),
                (p[c] *= 0.11),
                (s = 0.115926 * h);
            }
          ...
          o = (function () {
            for (
              ...
              (n[o] = (i + 0.02 * r) / 1.02), (i = n[o]), (n[o] *= 3.5);
            }
        ...
        (p5.Noise.prototype.setType = function (t) {
          ...
          (p5.Noise.prototype.start = function () {
            this.started && this.stop(),
              (this.noise = l.audiocontext.createBufferSource()),
  ...
  function (t, e, n) {
    ...
    void 0 ===
      (i = function (t) {
        var r = n(1);
        (r.inputSources = []),
          (p5.AudioIn = function (t) {
            (this.input = r.audiocontext.createGain()),
              (this.output = r.audiocontext.createGain()),
              (this.stream = null),
          ...
          (p5.AudioIn.prototype.start = function (e, n) {
            ...
            r.inputSources[this.currentSource] &&
              (o.audio.deviceId = t.deviceId),
              window.navigator.mediaDevices
                .getUserMedia(o)
                .then(function (t) {
                  (i.stream = t),
                    (i.enabled = !0),
                    (i.mediaStream = r.audiocontext.createMediaStreamSource(t)),
          ...
          (p5.AudioIn.prototype.amp = function (t, e) {
            if (e) {
              ...
              this.output.gain.cancelScheduledValues(
                r.audiocontext.currentTime
              ),
                this.output.gain.setValueAtTime(i, r.audiocontext.currentTime),
              ...
              this.output.gain.cancelScheduledValues(
                ...
                this.output.gain.setValueAtTime(t, r.audiocontext.currentTime);
          }),
          ...
          (p5.AudioIn.prototype.setSource = function (t) {
            0 < r.inputSources.length &&
              t < r.inputSources.length &&
                ...
                for (var e in u.Expr._Expressions) {
                  ...
                  for (var i in n) {
                    var o = n[i],
                      ...
                      s = t.match(r);
                    if (null !== s)
                      return { type: e, value: s[0], method: o.method };
                  }
                }
    ...
    (i = [n(0), n(5), n(19)]),
      void 0 ===
        (o = function (t) {
          ...
          return (
            (t.Abs = function () {
              this._abs = this.input = this.output = new t.WaveShaper(function (
                t
              ) {
          ...
          return (
            (e.Pow = function (t) {
              (this._exp = this.defaultArg(t, 1)),
                (this._expScaler = this.input = this.output = new e.WaveShaper(
      ...
      (n = function (t) {
        ...
        return (
          (p5.EQ = function (t) {
            var e, n, i;
            r.call(this),
              (e = 3 === (t = 3 === t || 8 === t ? t : 3) ? Math.pow(2, 3) : 2),
              (this.bands = []);
            for (var o = 0; o < t; o++)
              (i =
                o === t - 1
                  ...
                  : ((n =
                      1 === o
                        ? 3 === t
                          ? 360 * e
                          : 360
                        : this.bands[o - 1].freq() * e),
                    1)),
                (this.bands[o] = this._newBand(n, i)),
                0 < o
                  ? this.bands[o - 1].connect(this.bands[o].biquad)
                  : this.input.connect(this.bands[o].biquad);
            this.bands[t - 1].connect(this.output);
          }),
          (p5.EQ.prototype = Object.create(r.prototype)),
          (p5.EQ.prototype.process = function (t) {
            t.connect(this.input);
          }),
    ...
    void 0 ===
      (n = function (t) {
        ...
        var n = o(15),
          i = o(1);
        return (
          ((e.prototype = Object.create(n.prototype)).amp = function () {}),
          (e.prototype.drywet = function () {}),
    ...
    void 0 ===
      (i = function (t) {
        ...
        return (
          ...
          (p5.Panner3D.prototype = Object.create(e.prototype)),
          (p5.Panner3D.prototype.process = function (t) {
            t.connect(this.input);
          }),
            ...
            return (
              3 === arguments.length || 4 === arguments.length
                ...
                : (6 !== arguments.length && 7 !== arguments) ||
                  (this.orientForward(t, e, n), this.orientUp(i, o, r, s)),
              [
    ...
    void 0 ===
      (n = function (t) {
        ...
        (p5.Delay = function () {
          ...
          (p5.Delay.prototype = Object.create(n.prototype)),
          (p5.Delay.prototype.process = function (t, e, n, i) {
            var o = n || 0,
              r = e || 0;
            if (1 <= o)
              throw new Error(
    ...
    void 0 ===
      (i = function (t) {
        ...
        (p5.Reverb = function () {
          ...
          (p5.Reverb.prototype = Object.create(e.prototype)),
          ...
          (p5.Reverb.prototype._buildImpulse = function () {
            ...
            for (e = 0; e < i; e++)
              (t = this._reverse ? i - e : e),
                (s[e] = (2 * Math.random() - 1) * Math.pow(1 - t / i, o)),
                (a[e] = (2 * Math.random() - 1) * Math.pow(1 - t / i, o));
            this._setBuffer(r);
          }),
          ...
          (p5.Convolver = function (t, e, n) {
            p5.Reverb.call(this),
              ...
              (this.input.gain.value = 0.5),
              t
                ? ((this.impulses = []), this._loadBuffer(t, e, n))
                : ((this._seconds = 3),
                  (this._decay = 2),
                  (this._reverse = !1),
                  this._buildImpulse());
                  ...
                  a.decodeAudioData(
                    ...
                    function () {
                      var t = new p("decodeAudioData", s, r.url),
                        e =
                          "AudioContext error at decodeAudioData for " + r.url;
                      n && ((t.msg = e), n(t));
                    }
                  );
                else {
          ...
          (p5.Convolver.prototype.addImpulse = function (t, e, n) {
            -1 < window.location.origin.indexOf("file://") &&
              "undefined" === window.cordova &&
              alert(
                "This sketch may require a server to load external files. Please see http://bit.ly/1qcInwS"
          ...
          (p5.Convolver.prototype.dispose = function () {
            for (var t in (p5.Reverb.prototype.dispose.apply(this),
            this.impulses))
    ...
    void 0 ===
      (i = function (t) {
        var r = n(1),
          e = n(27);
        (p5.Metro = function () {
          (this.clock = new e({ callback: this.ontick.bind(this) })),
            (this.syncedParts = []),
            (this.bpm = 120),
            this._init(),
            (this.prevTick = 0),
          ...
          (p5.Metro.prototype.setBPM = function (t, e) {
            ...
            this.tatumTime = n;
            e = e || 0;
            this.clock.frequency.setValueAtTime(this.clock.frequency.value, i),
              this.clock.frequency.linearRampToValueAtTime(t, i + e),
              (this.bpm = t);
          }),
    ...
    void 0 ===
      (n = function (t) {
        ...
        (p5.prototype.setBPM = function (t, e) {
          for (var n in ((o = t), i.parts))
            i.parts[n] && i.parts[n].setBPM(t, e);
        }),
    ...
    void 0 ===
      (i = function (t) {
        ...
        return (
          ...
          (p5.Compressor.prototype = Object.create(e.prototype)),
          (p5.Compressor.prototype.process = function (t, e, n, i, o, r) {
      ...
      (i = function (t) {
        ...
        function o(t) {
          for (
            ...
            (e = (2 * r) / 44100 - 1),
              (i[r] = ((3 + n) * e * 20 * o) / (Math.PI + n * Math.abs(e)));
          return i;
        }
        (p5.Distortion = function (t, e) {
          if ((i.call(this), void 0 === t && (t = 0.25), "number" != typeof t))
          ...
          (this.waveShaperNode = this.ac.createWaveShaper()),
            (this.amount = n),
            (this.waveShaperNode.curve = o(n)),
            (this.waveShaperNode.oversample = e),
            this.input.connect(this.waveShaperNode),
            this.waveShaperNode.connect(this.wet);
        }),
          (p5.Distortion.prototype = Object.create(i.prototype)),
          (p5.Distortion.prototype.process = function (t, e, n) {
